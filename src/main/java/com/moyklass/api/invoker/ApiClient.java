...
public class ApiClient {
    ...
    private String basePath = "https://api.moyklass.com";
    ...
    public ApiClient() {
        ...
        authentications.put("companyApiKey", new ApiKeyAuth("header", "x-access-token"));
        authentications.put("userSession", new ApiKeyAuth("cookie", "SESSIONID"));
        authentications.put("xCookieToken", new ApiKeyAuth("cookie", "TOKEN"));
        authentications.put("xCsrfToken", new ApiKeyAuth("header", "x-csrf-token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.moyklass.com
